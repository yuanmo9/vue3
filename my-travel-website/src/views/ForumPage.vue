...
.user-info span {
  font-weight: bold;
  margin-right: 50px; /* 设置用户昵称和评分之间的间隔 */
...
.post {
  border-bottom: 1px dashed #ccc; /* 添加虚线隔开 */
  padding-bottom: 20px; /* 设置评论之间的间距 */
 margin-right: 25%
}
.post-content {
  width: 100%;
...
.comment-image {
  width: 200px; /* 设置评论图片宽度 */
  height: auto; /* 让高度自适应 */
  margin-top: 10px; /* 设置评论图片与评论内容之间的间距 */
}
